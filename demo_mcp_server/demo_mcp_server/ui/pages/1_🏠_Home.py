"""
Home/Dashboard page for Demo MCP Server Admin UI
...
# Page configuration
st.set_page_config(
    page_title="Demo MCP Server - Home",
    page_icon="🏠",
    layout="wide"
)
...
def render_project_overview():
    ...
    with col1:
        ...
        **Project Details:**
        ...
        - **Author:** Tim Kitchens
        - **Email:** timkitch@codingthefuture.ai
        """)
...
def main():
    """Main page content"""
    # Page header
    st.title("🏠 Demo MCP Server Admin Dashboard")
    ...
    # Footer
    st.markdown("---")
    st.caption(f"Demo MCP Server Admin UI • Generated with SAAGA MCP Server Cookie Cutter")
