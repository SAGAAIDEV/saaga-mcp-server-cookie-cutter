"""Demo MCP Server - MCP Server with SAAGA Decorators
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Demo MCP Server - MCP Server with SAAGA Decorators"
    )
    parser.add_argument(
        "--transport",
        choices=["stdio", "sse"],
    ...
    logger.info(f"Starting Demo MCP Server server...")
