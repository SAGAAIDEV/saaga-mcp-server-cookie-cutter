# AI Assistant Context for Test Config Server
...
```python
# In test_config_server/tools/my_tools.py
...
# Check logs
sqlite3 ~/Library/Application\ Support/test_config_server/logs.db
```
...
- **Tools**: `test_config_server/tools/`
- **Server**: `test_config_server/server/app.py`
- **Decorators**: `test_config_server/decorators/`
