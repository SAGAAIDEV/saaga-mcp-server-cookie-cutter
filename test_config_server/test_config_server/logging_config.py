"""Logging configuration for Test Config Server MCP server"""
...
from test_config_server.decorators.sqlite_logger import initialize_sqlite_logging
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the Test Config Server MCP server"""
    ...
    project_logger = logging.getLogger("test_config_server")
    ...
    log_file = log_path / "test_config_server.log"
...
logger = logging.getLogger("test_config_server")