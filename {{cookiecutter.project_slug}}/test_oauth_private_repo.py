    ...
    try:
        if transport == "http":
            ...
            server_process = subprocess.Popen(
                [sys.executable, "-m", "{{ cookiecutter.project_slug }}.server.app", 
                 "--transport", "streamable-http", "--port", "{{ cookiecutter.server_port }}"],
            ...
            # Connect via HTTP
            async with streamablehttp_client("http://localhost:{{ cookiecutter.server_port }}/mcp") as (read_stream, write_stream, get_session_id):
