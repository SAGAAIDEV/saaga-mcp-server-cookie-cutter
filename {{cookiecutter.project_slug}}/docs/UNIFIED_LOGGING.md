...
```python
from {{ cookiecutter.project_slug }}.logging import set_correlation_id, get_correlation_id
...
```python
from {{ cookiecutter.project_slug }}.logging import CorrelationContext, get_tool_logger
...
```python
from {{ cookiecutter.project_slug }}.logging.destinations import SQLiteDestination
