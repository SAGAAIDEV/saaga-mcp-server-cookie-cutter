"""Configuration management for UI Test Project
...
class ServerConfig:
    ...
    def __post_init__(self):
        ...
        if self.config_dir is None:
            self.config_dir = Path(platformdirs.user_config_dir("ui_test_project"))
        if self.data_dir is None:
            self.data_dir = Path(platformdirs.user_data_dir("ui_test_project"))
        if self.log_dir is None:
            self.log_dir = Path(platformdirs.user_log_dir("ui_test_project"))
        ...
        self.log_file_path = self.log_dir / "ui_test_project.log"
        self.database_path = self.data_dir / "ui_test_project.db"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ServerConfig":
        ...
        return cls(
            name=data.get("name", "UI Test Project"),
...
class UIConfig:
    ...
    # UI settings
    page_title: str = "UI Test Project Admin"
    page_icon: str = "🔧"
    layout: str = "wide"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "UIConfig":
        ...
        return cls(
            page_title=data.get("page_title", "UI Test Project Admin"),
...
def get_platform_info() -> Dict[str, str]:
    ...
    return {
        "config_dir": str(platformdirs.user_config_dir("ui_test_project")),
        "data_dir": str(platformdirs.user_data_dir("ui_test_project")),
        "log_dir": str(platformdirs.user_log_dir("ui_test_project")),
        "cache_dir": str(platformdirs.user_cache_dir("ui_test_project")),
    }
