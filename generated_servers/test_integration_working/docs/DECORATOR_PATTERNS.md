# SAAGA Decorator Patterns in Test Integration Working
...
2. **Enable Debug Logging**
   ```bash
   python -m test_integration_working.server.app --log-level DEBUG
   ```

3. **Check SQLite Logs**
   - Location: `test_integration_working/logs.db`
