# MCP Inspector Testing Guide for Test Integration Working
...
which mcp
# Should show: /path/to/test_integration_working/.venv/bin/mcp
...
1. Use the full path to your venv's mcp:
   ```bash
   .venv/bin/mcp dev test_integration_working/server/app.py
   ```
...
```bash
mcp dev test_integration_working/server/app.py
```
...
**Text Logs**:
- macOS: `~/Library/Logs/mcp-servers/test_integration_working.log`
- Linux: `~/.local/state/mcp-servers/logs/test_integration_working.log`
- Windows: `%LOCALAPPDATA%\mcp-servers\logs\test_integration_working.log`

**SQLite Database** (tool execution history):
- macOS: `~/Library/Application Support/test_integration_working/tool_logs.db`
- Linux: `~/.local/share/test_integration_working/tool_logs.db`
- Windows: `%LOCALAPPDATA%\test_integration_working\tool_logs.db`
...
```bash
streamlit run test_integration_working/ui/app.py
```
...
If you see `ModuleNotFoundError: No module named 'test_integration_working'`:

1. Ensure you're in the project root directory
2. Check virtual environment is activated: `which python`
3. Reinstall: `uv sync`
4. Use full mcp path: `.venv/bin/mcp dev test_integration_working/server/app.py`

### MCP Inspector Not Loading

1. Check server started without errors
2. Try a different port: `mcp dev test_integration_working/server/app.py --port 5174`
...
1. Add your own tools in `test_integration_working/tools/`
