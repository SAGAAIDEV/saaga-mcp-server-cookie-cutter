"""
Configuration management page for Test Integration Working Admin UI
...
def render_configuration_form(config):
    ...
    with st.form("config_form"):
        ...
        with col1:
            ...
            server_name = st.text_input("Server Name", value=server_config.get("name", "Test Integration Working"))
...
def handle_export_config(config):
    ...
    st.download_button(
        ...
        data=config_json,
        file_name="test_integration_working_config.json",
...
def render_environment_variables():
    ...
    env_vars = {
        "TEST_INTEGRATION_WORKING_LOG_LEVEL": "INFO",
        "TEST_INTEGRATION_WORKING_PORT": "3001",
        "TEST_INTEGRATION_WORKING_CONFIG_PATH": system_info.get("config_path", "~/.config/test_integration_working"),
        "TEST_INTEGRATION_WORKING_LOG_PATH": system_info.get("log_path", "~/.local/share/test_integration_working"),
...
def main():
    ...
    # Page header
    st.title("⚙️ Test Integration Working Configuration")
    ...
    with col2:
        ...
        st.download_button(
            ...
            data=config_yaml,
            file_name="test_integration_working_config.yaml",
