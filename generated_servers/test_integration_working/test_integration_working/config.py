"""Configuration management for Test Integration Working
...
class ServerConfig:
    ...
    # Server settings
    name: str = "Test Integration Working"
    ...
    def __post_init__(self):
        ...
        if self.config_dir is None:
            self.config_dir = Path(platformdirs.user_config_dir("test_integration_working"))
        if self.data_dir is None:
            self.data_dir = Path(platformdirs.user_data_dir("test_integration_working"))
        if self.log_dir is None:
            self.log_dir = Path(platformdirs.user_log_dir("test_integration_working"))
        ...
        self.log_file_path = self.log_dir / "test_integration_working.log"
        self.database_path = self.data_dir / "test_integration_working.db"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ServerConfig":
        ...
        return cls(
            name=data.get("name", "Test Integration Working"),
...
class UIConfig:
    ...
    # UI settings
    page_title: str = "Test Integration Working Admin"
    page_icon: str = "🔧"
    layout: str = "wide"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "UIConfig":
        ...
        return cls(
            page_title=data.get("page_title", "Test Integration Working Admin"),
...
def get_platform_info() -> Dict[str, str]:
    ...
    return {
        "config_dir": str(platformdirs.user_config_dir("test_integration_working")),
        "data_dir": str(platformdirs.user_data_dir("test_integration_working")),
        "log_dir": str(platformdirs.user_log_dir("test_integration_working")),
        "cache_dir": str(platformdirs.user_cache_dir("test_integration_working")),
    }
