"""Logging configuration for Test Integration Working MCP server"""
...
from test_integration_working.decorators.sqlite_logger import initialize_sqlite_logging
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the Test Integration Working MCP server"""
    ...
    project_logger = logging.getLogger("test_integration_working")
    ...
    log_file = log_path / "test_integration_working.log"
...
logger = logging.getLogger("test_integration_working")