"""Test MCP Server - MCP Server with SAAGA Decorators
...
from test_mcp_server.logging.correlation import (
    generate_correlation_id,
    set_initialization_correlation_id,
    clear_initialization_correlation_id
)
from test_mcp_server.logging.unified_logger import UnifiedLogger
...
def create_mcp_server(config: Optional[ServerConfig] = None) -> FastMCP:
    ...
    from test_mcp_server.logging.destinations import DestinationConfig
