...
class ServerConfig:
    ...
    description: str = "Test MCP server generated for development testing"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ServerConfig":
        ...
        return cls(
            ...
            description=data.get("description", "Test MCP server generated for development testing"),
...
class UIConfig:
    ...
    # UI settings
    page_title: str = "Test MCP Server Admin"
    page_icon: str = "🔧"
    layout: str = "wide"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "UIConfig":
        ...
        return cls(
            page_title=data.get("page_title", "Test MCP Server Admin"),
