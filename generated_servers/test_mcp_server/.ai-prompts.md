# AI Assistant Context for Test MCP Server
...
```python
# In test_mcp_server/tools/my_tools.py
...
# Check logs
sqlite3 ~/Library/Application\ Support/test_mcp_server/logs.db
```
...
- **Tools**: `test_mcp_server/tools/`
- **Server**: `test_mcp_server/server/app.py`
- **Decorators**: `test_mcp_server/decorators/`
