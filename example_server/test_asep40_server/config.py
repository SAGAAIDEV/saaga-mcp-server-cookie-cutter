"""Configuration management for Test ASEP40 Server
...
class ServerConfig:
    ...
    def __post_init__(self):
        ...
        if self.config_dir is None:
            self.config_dir = Path(platformdirs.user_config_dir("test_asep40_server"))
        if self.data_dir is None:
            self.data_dir = Path(platformdirs.user_data_dir("test_asep40_server"))
        if self.log_dir is None:
            self.log_dir = Path(platformdirs.user_log_dir("test_asep40_server"))
        ...
        self.log_file_path = self.log_dir / "test_asep40_server.log"
        self.database_path = self.data_dir / "test_asep40_server.db"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ServerConfig":
        ...
        return cls(
            name=data.get("name", "Test ASEP40 Server"),
...
def get_platform_info() -> Dict[str, str]:
    ...
    return {
        "config_dir": str(platformdirs.user_config_dir("test_asep40_server")),
        "data_dir": str(platformdirs.user_data_dir("test_asep40_server")),
        "log_dir": str(platformdirs.user_log_dir("test_asep40_server")),
        "cache_dir": str(platformdirs.user_cache_dir("test_asep40_server")),
    }
