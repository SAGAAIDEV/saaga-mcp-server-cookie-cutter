"""Logging configuration for Test ASEP40 Server MCP server"""
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the Test ASEP40 Server MCP server"""
    ...
    project_logger = logging.getLogger("test_asep40_server")
    ...
    log_file = log_path / "test_asep40_server.log"
...
logger = logging.getLogger("test_asep40_server")