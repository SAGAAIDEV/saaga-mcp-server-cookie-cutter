# AI Assistant Context for Example MCP Server
...
```python
# In example_mcp_server/tools/my_tools.py
...
# Check logs
sqlite3 ~/Library/Application\ Support/example_mcp_server/logs.db
```
...
- **Tools**: `example_mcp_server/tools/`
- **Server**: `example_mcp_server/server/app.py`
- **Decorators**: `example_mcp_server/decorators/`
