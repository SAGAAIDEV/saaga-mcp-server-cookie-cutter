...
def handle_export_config(config):
    ...
    st.download_button(
        ...
        data=config_json,
        file_name="example_mcp_server_config.json",
...
def render_environment_variables():
    ...
    env_vars = {
        "EXAMPLE_MCP_SERVER_LOG_LEVEL": "INFO",
        "EXAMPLE_MCP_SERVER_PORT": "3001",
        "EXAMPLE_MCP_SERVER_CONFIG_PATH": system_info.get("config_path", "~/.config/example_mcp_server"),
        "EXAMPLE_MCP_SERVER_LOG_PATH": system_info.get("log_path", "~/.local/share/example_mcp_server"),
...
def main():
    ...
    with col2:
        ...
        st.download_button(
            ...
            data=config_yaml,
            file_name="example_mcp_server_config.yaml",
