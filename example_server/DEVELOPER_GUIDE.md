# Developer Guide - Example Server
...
```python
# example_server/tools/my_tools.py
...
```python
from example_server.tools.my_tools import my_tools, my_parallel_tools
```
...
uv run pytest --cov=example_server --cov-report=html
