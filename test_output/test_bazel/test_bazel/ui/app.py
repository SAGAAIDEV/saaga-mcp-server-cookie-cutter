"""
Streamlit Admin UI for Test Bazel
...
Run with: streamlit run test_bazel/ui/app.py
"""
...
try:
    ...
    def get_project_info():
        return {"name": "Test Bazel", "version": "0.1.0"}

# Page configuration
st.set_page_config(
    page_title="Test Bazel Admin",
    page_icon="🛠️",
    layout="wide",
