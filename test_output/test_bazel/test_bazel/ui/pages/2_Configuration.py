"""
Configuration management page for Test Bazel Admin UI
...
def render_configuration_form(config):
    ...
    with st.form("config_form"):
        ...
        with col1:
            ...
            server_name = st.text_input("Server Name", value=server_config.get("name", "Test Bazel"))
...
def handle_export_config(config):
    ...
    st.download_button(
        ...
        data=config_json,
        file_name="test_bazel_config.json",
...
def render_environment_variables():
    ...
    env_vars = {
        "TEST_BAZEL_LOG_LEVEL": "INFO",
        "TEST_BAZEL_PORT": "3001",
        "TEST_BAZEL_CONFIG_PATH": system_info.get("config_path", "~/.config/test_bazel"),
        "TEST_BAZEL_LOG_PATH": system_info.get("log_path", "~/.local/share/test_bazel"),
...
def main():
    ...
    # Page header
    st.title("⚙️ Test Bazel Configuration")
    ...
    with col2:
        ...
        st.download_button(
            ...
            data=config_yaml,
            file_name="test_bazel_config.yaml",
