"""Configuration management for Test Bazel
...
class ServerConfig:
    ...
    def __post_init__(self):
        ...
        if self.config_dir is None:
            self.config_dir = Path(platformdirs.user_config_dir("test_bazel"))
        if self.data_dir is None:
            self.data_dir = Path(platformdirs.user_data_dir("test_bazel"))
        if self.log_dir is None:
            self.log_dir = Path(platformdirs.user_log_dir("test_bazel"))
        ...
        self.log_file_path = self.log_dir / "test_bazel.log"
        self.database_path = self.data_dir / "test_bazel.db"
...
class UIConfig:
    ...
    # UI settings
    page_title: str = "Test Bazel Admin"
    page_icon: str = "🔧"
    layout: str = "wide"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "UIConfig":
        ...
        return cls(
            page_title=data.get("page_title", "Test Bazel Admin"),
...
def get_platform_info() -> Dict[str, str]:
    ...
    return {
        "config_dir": str(platformdirs.user_config_dir("test_bazel")),
        "data_dir": str(platformdirs.user_data_dir("test_bazel")),
        "log_dir": str(platformdirs.user_log_dir("test_bazel")),
        "cache_dir": str(platformdirs.user_cache_dir("test_bazel")),
    }
