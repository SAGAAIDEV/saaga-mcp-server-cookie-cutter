"""Logging configuration for Test Bazel MCP server"""
...
from test_bazel.config import ServerConfig
from test_bazel.decorators.sqlite_logger import initialize_sqlite_logging
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the Test Bazel MCP server"""
    ...
    project_logger = logging.getLogger("test_bazel")
    ...
    log_file = log_path / "test_bazel.log"
...
logger = logging.getLogger("test_bazel")