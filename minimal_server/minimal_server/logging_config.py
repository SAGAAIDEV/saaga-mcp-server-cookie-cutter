"""Logging configuration for Minimal Server MCP server"""
...
from minimal_server.decorators.sqlite_logger import initialize_sqlite_logging
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the Minimal Server MCP server"""
    ...
    project_logger = logging.getLogger("minimal_server")
    ...
    log_file = log_path / "minimal_server.log"
