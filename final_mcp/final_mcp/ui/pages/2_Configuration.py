"""
Configuration management page for final mcp Admin UI
...
try:
    from final_mcp.ui.lib.components import (
        render_info_card,
        render_warning_banner,
        render_config_section
    )
    from final_mcp.ui.lib.utils import (
        load_configuration,
...
def render_configuration_form(config):
    ...
    with st.form("config_form"):
        ...
        with col1:
            ...
            server_name = st.text_input("Server Name", value=server_config.get("name", "final mcp"))
...
def handle_export_config(config):
    ...
    st.download_button(
        ...
        data=config_json,
        file_name="final_mcp_config.json",
...
def render_environment_variables():
    ...
    env_vars = {
        "FINAL_MCP_LOG_LEVEL": "INFO",
        "FINAL_MCP_PORT": "3001",
        "FINAL_MCP_CONFIG_PATH": system_info.get("config_path", "~/.config/final_mcp"),
        "FINAL_MCP_LOG_PATH": system_info.get("log_path", "~/.local/share/final_mcp"),
...
def main():
    ...
    # Page header
    st.title("⚙️ final mcp Configuration")
    ...
    with col2:
        ...
        st.download_button(
            ...
            data=config_yaml,
            file_name="final_mcp_config.yaml",
