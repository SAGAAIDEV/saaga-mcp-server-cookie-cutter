"""
Streamlit Admin UI for final mcp
...
Run with: streamlit run final_mcp/ui/app.py
"""
...
try:
    from final_mcp.ui.lib.components import render_header, render_sidebar, render_error_message
    from final_mcp.ui.lib.styles import apply_custom_styles, hide_streamlit_style
    from final_mcp.ui.lib.utils import check_server_status, get_project_info
    ...
    def get_project_info():
        return {"name": "final mcp", "version": "0.1.0"}

# Page configuration
st.set_page_config(
    page_title="final mcp Admin",
    page_icon="🛠️",
    layout="wide",
