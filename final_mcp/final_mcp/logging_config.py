"""Logging configuration for final mcp MCP server"""
...
from final_mcp.decorators.sqlite_logger import initialize_sqlite_logging
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the final mcp MCP server"""
    ...
    project_logger = logging.getLogger("final_mcp")
    ...
    log_file = log_path / "final_mcp.log"
