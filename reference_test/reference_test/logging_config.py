"""Logging configuration for Reference Test MCP server"""
...
from reference_test.config import ServerConfig
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the Reference Test MCP server"""
    ...
    project_logger = logging.getLogger("reference_test")
    ...
    log_file = log_path / "reference_test.log"
