"""Logging configuration for Fixed MCP Server MCP server"""
...
from fixed_mcp_server.config import ServerConfig
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the Fixed MCP Server MCP server"""
    ...
    project_logger = logging.getLogger("fixed_mcp_server")
    ...
    log_file = log_path / "fixed_mcp_server.log"
