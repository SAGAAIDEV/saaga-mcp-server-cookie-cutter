...
The Sizzle MCP Server implements a unified logging system that captures both tool executions and internal application logs in a single, queryable database. The system features:
...
```python
from sizzle_mcp_server.logging import set_correlation_id, get_correlation_id
...
```python
from sizzle_mcp_server.logging import get_tool_logger
...
```python
from sizzle_mcp_server.decorators import tool_logger
...
```python
from sizzle_mcp_server.logging import CorrelationContext, get_tool_logger
...
```python
from sizzle_mcp_server.logging.destinations import SQLiteDestination
