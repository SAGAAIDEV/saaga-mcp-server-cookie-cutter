"""Configuration management for Sizzle MCP Server
...
class ServerConfig:
    ...
    def __post_init__(self):
        ...
        if self.config_dir is None:
            self.config_dir = Path(platformdirs.user_config_dir("sizzle_mcp_server"))
        if self.data_dir is None:
            self.data_dir = Path(platformdirs.user_data_dir("sizzle_mcp_server"))
        if self.log_dir is None:
            self.log_dir = Path(platformdirs.user_log_dir("sizzle_mcp_server"))
        ...
        self.log_file_path = self.log_dir / "sizzle_mcp_server.log"
        self.database_path = self.data_dir / "sizzle_mcp_server.db"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ServerConfig":
        ...
        return cls(
            name=data.get("name", "Sizzle MCP Server"),
...
def get_platform_info() -> Dict[str, str]:
    ...
    return {
        "config_dir": str(platformdirs.user_config_dir("sizzle_mcp_server")),
        "data_dir": str(platformdirs.user_data_dir("sizzle_mcp_server")),
        "log_dir": str(platformdirs.user_log_dir("sizzle_mcp_server")),
        "cache_dir": str(platformdirs.user_cache_dir("sizzle_mcp_server")),
    }
