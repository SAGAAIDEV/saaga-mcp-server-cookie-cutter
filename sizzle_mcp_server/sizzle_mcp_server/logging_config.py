"""Logging configuration for Sizzle MCP Server MCP server"""
...
from sizzle_mcp_server.decorators.sqlite_logger import initialize_sqlite_logging
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the Sizzle MCP Server MCP server"""
    ...
    project_logger = logging.getLogger("sizzle_mcp_server")
    ...
    log_file = log_path / "sizzle_mcp_server.log"
...
logger = logging.getLogger("sizzle_mcp_server")